...
DailyAnalysisLimitSchema.statics.canUserAnalyze = async function(userEmail, userId, limit = 10) {
...
DailyAnalysisLimitSchema.statics.getUserDailyStats = async function(userEmail, userId) {
	const today = this.getTodayDateString();
...
DailyAnalysisLimitSchema.statics.cleanupOldRecords = async function(daysToKeep = 30) {
