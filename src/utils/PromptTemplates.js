...
`,
		...
		fallbackResponse: {
			...
			description:
				"根據您的出生信息，本年度整體運勢呈現平穩上升的趨勢。建議保持積極的心態，把握機遇的同時也要注意防範風險。在您關注的領域中，特別要注意平衡發展，不宜過於急進。",
...
`,
		...
		fallbackResponse: {
			summary: "命局顯示您具有良好的發展潛能",
			description:
				"您的命局結構顯示出均衡發展的特質，具有多方面的才能和適應性。在人際交往中表現穩重，能夠獲得他人信任。建議在您擅長的領域深入發展，同時保持開放的心態學習新事物。",
