...
export default function BeforeAfter() {
	...
	return (
		<section className="relative py-8 overflow-hidden sm:py-12 md:py-16 lg:py-20 xl:pb-30 xl:pt-30 bg-secondary">
			...
			<div className="container px-4 mx-auto sm:px-6 md:px-8">
				<div className="flex flex-col items-center max-w-6xl gap-8 mx-auto sm:gap-10 md:gap-12 lg:flex-row lg:gap-16 xl:gap-24">
					...
					<div className="flex flex-col items-center flex-grow gap-4 sm:gap-5 md:gap-6 lg:items-start">
						<h3 className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-4xl xl:text-5xl font-bold text-center lg:text-left text-hero">
							{t("title")}
						</h3>
						<p className="text-center text-secondary-foreground text-sm sm:text-base md:text-lg lg:text-xl lg:text-left max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-90">
							{t("description")}
						</p>
