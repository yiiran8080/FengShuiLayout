...
export default function Theory({ bgColor = "bg-[#f0f8f6]" }) {
    ...
    return (
        ...
        >
            {/* Title Section */}
            <section className="w-full flex flex-row items-start justify-center max-w-full text-left text-2xl sm:text-3xl md:text-[40px] text-[#073e31] mb-6 sm:mb-10" style={{ fontFamily: "Noto Serif TC, serif" }}>
                <div className="w-full max-w-[729px] flex flex-col items-start justify-start gap-4">
                    <div className="flex flex-row flex-wrap items-end justify-start max-w-full gap-4 md:gap-9">
                        ...
                        <div className="flex flex-row items-center justify-center p-2.5 box-border max-w-full z-[1]">
                            <h2 className="m-0 relative text-[length:inherit] leading-8 font-bold text-xl sm:text-2xl md:text-3xl lg:text-[40px] mq925:text-2xl mq925:leading-[19px] mq450:text-[24px] mq450:leading-[26px]" style={{ fontFamily: "Noto Serif TC, serif" }}>
                                {t("title")}
                            </h2>
                        </div>
                    </div>
                    <div className="self-stretch flex flex-row items-start justify-start py-0 pl-2 pr-0 text-center text-base sm:text-lg md:text-xl text-[#004f44]" style={{ fontFamily: "Noto Serif TC, serif" }}>
            ...
            {/* Card Section */}
            <section className="w-full flex flex-col md:flex-row items-stretch justify-center gap-4 sm:gap-6 md:gap-8 text-left text-base sm:text-lg md:text-2xl text-[#fff]" style={{ fontFamily: "Noto Serif TC, serif" }}>
                {/* Card 1 */}
                    ...
                    <div className="w-full md:w-60 h-[170px] sm:h-[180px] md:h-[211px] flex flex-col items-start justify-start gap-4 sm:gap-[11px]">
                        <div className="w-full md:w-[231px] flex flex-col items-start justify-start gap-4 sm:gap-6">
                            ...
                            <div className="flex flex-row items-center justify-center">
                                <h3 className="m-0 relative text-[length:inherit] tracking-[-0.03em] leading-[150%] font-semibold text-base sm:text-lg md:text-xl" style={{ fontFamily: "Noto Serif TC, serif" }}>
                                    {t("cards.imageRecognition.title")}
                                </h3>
                            </div>
                        </div>
                        <div className="relative self-stretch text-sm leading-6 sm:text-base" style={{ fontFamily: "Noto Serif TC, serif" }}>
