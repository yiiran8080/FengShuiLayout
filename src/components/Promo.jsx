...
export default function Promo() {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between rounded-[15px] sm:rounded-[20px] mx-2 sm:mx-6 lg:mx-10 bg-[#f5faf7] pt-4 pb-6 px-4 sm:pt-6 sm:pb-8 sm:px-6 md:pt-8 md:pb-10 md:px-8 lg:pt-10 lg:pb-[72px] lg:pl-[84px] lg:pr-[93px] gap-4 sm:gap-6 md:gap-8 lg:gap-24" style={{ boxShadow: "0 4px 15px rgba(0, 0, 0, 0.3)" }}>
            <section className="flex-1 flex flex-col items-start justify-start max-w-full text-left text-Neutral-07-100 font-[Poppins]">
                <div className="flex flex-col items-start justify-start w-full gap-4 sm:gap-6 md:gap-8 lg:gap-11">
                    ...
                    <Link href="/price" className="w-full max-w-[200px] sm:max-w-[220px] md:max-w-[247px]">
                        <button className="cursor-pointer border-none p-0 bg-transparent w-full h-[40px] sm:h-[44px] md:h-[48px] lg:h-[60px] flex flex-row items-start justify-start relative hover:scale-105 transition-transform duration-300" style={{ filter: "drop-shadow(0 4px 15px rgba(0, 0, 0, 0.3))" }}>
