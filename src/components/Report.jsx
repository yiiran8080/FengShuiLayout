        ...
        <div className="relative min-h-screen bg-white">
            ...
            <div className="max-w-250 mx-auto  md:px-5">
                        ...
                        reportDocData.yunchengData[nayin][random].map((item, index) => {
                            return <section
                                ...
                                <div className='flex justify-between items-center'>
                                    <p className={`leading-8 text-xl font-bold flex items-center`} style={{ color: sections[1].children[index].color }}>
                ...
                <div key='section-2'>
                    ...
                    <RoomSection locale={locale} designJsonData={designJsonData} />
                </div>
            </div>
        </div>
    );
