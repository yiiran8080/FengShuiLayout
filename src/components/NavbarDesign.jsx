...
export default function NavbarDesign({ onSaveProject, onUserOpen }) {
  ...
  return (
    <nav className="bg-white h-16 border-b-gray-100 border-b-2 fixed top-0 left-0 right-0 ">
      <div className="mx-auto px-4 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center space-x-4 text-foreground  gap-3">
            ...
            <span className='flex items-center gap-1 cursor-pointer' onClick={() => onUserOpen(true)}><Save className="w-4 h-4" />个人资料 </span>
            <Link
              href="/design"
