...
export default function UploadPic2({ onResult }) {
	...
	return (
		<div
			className="flex flex-col items-center justify-start w-full px-4 py-6 mb-10 text-center sm:px-6 md:px-8 lg:px-0"
			style={{ fontFamily: '"Noto Serif TC", serif' }}
		>
			{/* Title */}
			<h1 className="mb-4 text-xl font-normal mt-3 mb-2 text-[#004f44] sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl leading-tight sm:leading-normal">
				{t("modalTitle")}
			</h1>{" "}
			<p className="mb-4 text-xl font-normal mt-3 mb-10 text-[#004f44] sm:text-xl md:text-xl lg:text-xl xl:text-xl leading-tight sm:leading-normal">
				{t("modalTitle2")}
			</p>
			{/* User Info Form */}
			<div className="w-full max-w-md mx-auto">
				<div className="p-1 bg-white shadow-2xl rounded-xl">
					{/* Form Body */}
					<div className="p-4 space-y-4 sm:p-6 sm:space-y-6">
						...
						<div className="space-y-2">
							...
							>
								<option value="">{t("roomTypeSelect")}</option>
								{roomTypes.map((type) => (
						...
						<div className="space-y-2">
							...
							>
								<option value="">{t("directionSelect")}</option>
								{directions.map((dir) => (
