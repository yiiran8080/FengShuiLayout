            ...
            <div className="w-full max-w-full p-2 mt-4 sm:p-4 sm:mt-6 lg:p-8 lg:mt-10 rounded-xl">
                <>
                    ...
                    <div className="flex-1 rounded-2xl sm:mb-8 lg:mb-13 bg-[#f5faf7] flex flex-col items-start justify-start pt-4 sm:pt-6 lg:pt-[40px] px-3 sm:px-4 lg:px-[30px] pb-4 sm:pb-6 lg:pb-[37px] box-border gap-3 sm:gap-4 lg:gap-8 z-[1] shadow-[0_8px_32px_rgba(0,0,0,0.15)]">
                        ...
                        <div className="w-full sm:w-[250px] lg:w-[570px] flex flex-col items-center gap-2 mx-auto">
                            {preview && (
                                <img
                                    src={preview}
                                    alt={t("uploadedImage")}
                                    className="object-cover mb-2 rounded-lg w-full max-w-[300px] sm:w-170 sm:h-90 h-auto"
                                />
                            )}
                        </div>
                                                ...
                                                >
                                                    ...
                                                    {(item.title ===
                                                        ...
                                                        <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-black/10">
                                                            <Link href="/price">
                                                                <button className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold text-white transition-shadow duration-300 rounded-full bg-[rgba(49,129,97)] hover:shadow-xl" style={{ boxShadow: "0 4px 15px rgba(0, 0, 0, 0.3)" }}>
                                                                    {t("unlockDetail")}
                                                                </button>
                                                            </Link>
                                                        </div>
