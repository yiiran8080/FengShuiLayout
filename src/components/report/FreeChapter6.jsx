                            ...
                            .map((item, index) => (
                                <div key={index} className="relative w-full">
                                    ...
                                    >
                                        ...
                                        {index === 1 && (
                                            <div className="absolute left-0 bottom-0 w-full h-full pointer-events-none rounded-b-[20px] bg-gradient-to-t from-white/90 via-white/60 to-transparent backdrop-blur-sm flex items-center justify-center">
                                                <Link href="/price">
                                                    <button
