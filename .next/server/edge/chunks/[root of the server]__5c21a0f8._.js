(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__5c21a0f8._.js", {
...
async function middleware(request) {
    ...
    const isPublicRoute = pathname === "/" || pathname.startsWith("/auth") || pathname.startsWith("/api") || pathname.startsWith("/_next") || pathname.startsWith("/static") || pathname.includes(".") || pathname.includes("/auth/login") || pathname === "/favicon.ico" || pathname.includes("/price") || // 添加 price 頁面為公共路由
    ...
    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$jwt$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getToken"])({
        secureCookie: ("TURBOPACK compile-time value", "development") !== "development",
        req: request,
    ...
    if (!token) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/${locale}/auth/login?callbackUrl=${request.nextUrl.pathname}`, request.url));
    }
    return response;
}
const config = {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5c21a0f8._.js.map